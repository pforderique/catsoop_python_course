...
cs_base_color = "#007886"  # the base color
cs_header = "6.101"  # the upper-left corner
cs_icon_url = "COURSE/python_logo.png"  # the favicon, if any
# the 'header' text for the page
cs_long_name = cs_content_header = "Orderique Python Course"
cs_title = "Orderique Python Course"  # the browser's title bar
...
cs_top_menu = [
    {"link": "COURSE", "text": "Homepage"},
    {
        ...
        "link": [
            ...
            {"text": "Lesson 7: Classes", "link": "COURSE/modules/lesson7"},
        ]
    },
    {
        "text": "Pages",
